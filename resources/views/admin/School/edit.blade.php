        ...
        <div class="card-body">
            <form action="{{route('admin.school.update',$school->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea id="school_description" name="school_description" class="form-control" cols="30" rows="11">{{$school->school_description}}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="school_detail" class="form-control" id="school_detail" cols="30" rows="5">{{$school->school_detail}}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    @php
                        $typeChecks = json_decode($school->types);
                    @endphp
                    <div class="dropdown_inner">
                        @foreach($types as $item)
                            <div class="type_checkbox">
                                @php   
                                    $checked = ($typeChecks != null && in_array($item->id, $typeChecks)) ? 'checked' : '';
                                @endphp
                                <input type="checkbox" {{$checked}} value="{{$item->id}}" id="type-{{$item->id}}" name="type[]"/> 
